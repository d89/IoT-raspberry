...
io.on('connection', function(socket)
{
	...
	socketType === "ui" && socket.on('ui:full', function(msg, resp)
	{
		...
		dp.getDataPoints(type, function(data)
		{
    ...
    {
        console.log("last hour request from ui: ", msg);

        storage.aggregateLastHour(types, function(err, dps)
        {
            //console.log("responding to last hour request", dps);
            resp(dps);
        });
    });
    ...
    {
        console.log("hours of day request from ui: ", msg);

        storage.aggregateHoursOfDay(types, function(err, dps)
        {
            //console.log("responding to hours of day request", dps);
            resp(dps);
        });
    });
    ...
    {
        console.log("days of month request from ui: ", msg);

        storage.aggregateDaysOfMonth(types, function(err, dps)
        {
            //console.log("responding to days of month request", dps);
            resp(dps);
        });
    });
