...
var Styles = function() {
    ...
    var uiYearCopy = function() {
        ...
        $yearCopy.html($date.getFullYear());
    };
     ...
     *
     * Styles.initHelper('appear-countTo');
     *
     */
     ...
     *
     * Styles.initHelper('magnific-popup');
     *
     */
     ...
     *
     * Styles.initHelper('masked-inputs');
     *
     */
     ...
     *
     * Styles.initHelper('draggable-items');
     *
     */
     ...
     *
     * Styles.initHelper('easy-pie-chart');
     *
     */
     ...
     *
     * Styles.initHelper('datetimepicker');
     *
     */
        ...
        initHelpers: function($helpers) {
            if ($helpers instanceof Array) {
                for(var $index in $helpers) {
                    Styles.initHelper($helpers[$index]);
                }
            } else {
                Styles.initHelper($helpers);
            }
        }
    };
}();
